 ...
 * + Queueing book loans
 */
class SifriTaub @Inject constructor(private val db: DB) {
    /**
    ...
    /**
     * List the ids of the first [n] ****available*** unique books (no id should appear twice).
     *
     * This is a *read* operation.
     *
     * @param token A token used to authenticate the requesting user
